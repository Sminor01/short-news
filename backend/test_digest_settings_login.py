#!/usr/bin/env python3
"""
Test DigestSettings with login
"""
...
async def test_digest_settings_with_login():
    """Test DigestSettings with login"""
    print("Testing DigestSettings with login...")
...
async def main():
    """Main test function"""
    print("=" * 60)
    print("DIGEST SETTINGS LOGIN TEST")
    print("=" * 60)
    
    success = await test_digest_settings_with_login()
    
    print("\n" + "=" * 60)
    if success:
        print("[SUCCESS] LOGIN TESTS PASSED!")
        print("DigestSettings API works correctly with login.")
    else:
        print("[FAILED] LOGIN TESTS FAILED!")
